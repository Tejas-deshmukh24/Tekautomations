...
public class DownloadInvoiceAfterPurchaseOrder {
	...
	@Test
	public void DownloadInvoiceAfterPurchaseOrder() throws Throwable {
		...
		act.scrollByAmount(0, 1600).perform();

		driver.findElement(By.xpath("(//a[@class='btn btn-default add-to-cart'][normalize-space()='Add to cart'])[69]")).click();
		...
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("tejas466@gmail.com");
		...
		act1.scrollToElement(driver.findElement(By.xpath("//a[@href='/brand_products/Biba']"))).perform();
